...
def main() -> None:
    ...
    train_y_path = args.output_dir / "train_labels.csv"
    val_y_path = args.output_dir / "val_labels.csv"
    train_x_path = args.output_dir / "train_features.npy"
    val_x_path = args.output_dir / "val_features.npy"
